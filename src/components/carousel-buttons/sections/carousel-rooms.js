export default function carouselRooms() {
    ...
    const buttonForRight = document.getElementById('right-slider-rooms');
    const buttonForLeft = document.getElementById('left-slider-rooms');
    const labelsForSliderRadioButton = document.querySelectorAll('.slider-for-rooms');
    let offset = 0;
    let count = 0;
